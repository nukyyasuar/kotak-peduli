...
export default function AdminConsoleDashboard() {
  ...
  const fetchAnalytics = async () => {
    try {
      ...
      toast.success("Data analitik berhasil dimuat");
    } catch (error) {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.error(
        `Gagal ${type === "approve" ? "menyetujui" : "menolak"} tempat penampung. Silakan coba lagi`
      );
    }
  };
      ...
      {!canReadCollection ? (
        ...
        <main>
          <div className="max-w-[1200px] mx-auto py-12">
            <h1 className="text-[32px] text-[#543A14] font-bold text-center mb-5">
              RINGKASAN DATA
            </h1>
          ...
          {/* Section Tabel */}
          <div className="bg-[#F5E9D4] py-12">
            <main className="max-w-[1200px] min-h-130 mx-auto space-y-4 text-black">
                    ...
                    <tbody>
                      {dataCollectionCenters.map((item, index) => {
                        ...
                        return (
                          <tr
                            key={index}
                            className="border-b border-b-[#EDEDED]"
                          >
                  ...
                  {isApproveModalOpen ? (
                    <p>
                      ...
                      <span className="font-bold">
                        tempat penampungan akan terlihat oleh donatur, sehingga
                        dapat mulai menerima donasi dan mengakses dashboard
                        untuk pengelolaan
                      </span>
                    ...
                    <p>
                      Tempat penampungan tidak akan dapat menerima donasi dan
                      tidak terlihat oleh donatur.{" "}
                      <span className="font-bold">
                        Apakah Anda yakin ingin menolak pendaftaran tempat
                        penampungan ini?{" "}
                      </span>
                    </p>
                  )}
