...
const statusList = [
  { label: "Semua", value: "" },
  { label: "Pemeriksaan Digital", value: "pemeriksaan_digital" },
  { label: "Pengiriman", value: "pengiriman" },
  { label: "Penjemputan", value: "penjemputan" },
  { label: "Diterima", value: "diterima" },
  { label: "Pemeriksaan Fisik", value: "pemeriksaan_fisik" },
  { label: "Disetujui", value: "disetujui" },
  { label: "Dialihkan", value: "dialihkan" },
  { label: "Disalurkan", value: "disalurkan" },
];

const imageSrcList = ["/matthew.png", "/banner_home.webp", "/nuky.png"];
...
export default function RiwayatDonasi() {
  ...
  return (
    <section className="space-y-6 ">
      ...
      >
        <div className="min-w-[180px] aspect-square bg-[#C2C2C2] rounded-b-lg" />

        <div className="w-full">
          <div className="flex flex-col justify-between text-black text-sm h-full">
            <div className="flex justify-between items-start">
              <div className="flex flex-col gap-1">
                <span className="font-bold">Tempat Penampung Alam Sutera</span>
            ...
            <div className="flex justify-between">
              <div className="space-y-1">
                <div className="flex gap-2">
                  <span>Event:</span>
                  <span>Banjir Tangerang</span>
                </div>
                <span>Pakaian (10pcs, 10kg)</span>
              </div>
              <div className="space-y-1">
                <div className="flex gap-2">
                  <span>Metode Pengiriman:</span>
                  <span>Dikirim Sendiri</span>
                </div>
                <div className="flex gap-2">
          ...
          >
            ...
            <div className="flex space-x-8">
              ...
              <div className="w-80 space-y-6">
                ...
                <div className="flex gap-2 overflow-scroll no-scrollbar">
                  {imageSrcList.map((src, index) => (
                    <div className="bg-[#C2C2C2] rounded-lg min-w-16 aspect-square relative">
                      <Image
                        key={index}
                        src={src}
                        alt="Donation item image small"
                        fill
                        className="object-cover rounded-lg"
                        onClick={() => {
                          setImgSrc(src);
                  ...
                  <div className="bg-[#C2C2C2] rounded-lg min-w-16 aspect-square"></div>
                  <div className="bg-[#C2C2C2] rounded-lg min-w-16 aspect-square"></div>
                  <div className="bg-[#C2C2C2] rounded-lg min-w-16 aspect-square"></div>
                  <div className="bg-[#C2C2C2] rounded-lg min-w-16 aspect-square"></div>
                  <div className="bg-[#C2C2C2] rounded-lg min-w-16 aspect-square"></div>
              ...
              <div className="space-y-4">
                ...
                <ListTextWithTitle
                  title="Barang Donasi:"
                  values={["Pakaian (10pcs, 5kg)"]}
                />
                <ListTextWithTitle
                  title="Detail Tempat Penampung:"
                  values={[
                    "Tempat Penampung Alam Sutera",
                    "Drop Point Tangerang Kota",
                    "Jl. Lorem ipsum dolor sit amet, consectetur adipiscing elit",
                    <TextBetween label="Event" value="Banjir Tangerang" />,
                  ]}
                />
                <ListTextWithTitle
                  title="Informasi Pengiriman:"
                  values={[
                    "Dikirim sendiri oleh donatur",
                    <TextBetween
